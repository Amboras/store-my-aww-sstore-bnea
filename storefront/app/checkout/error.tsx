...
import { AlertCircle, RefreshCw, ArrowUpRight, ShoppingBag } from 'lucide-react'
          ...
          <div className="mx-auto max-w-lg hev-shell rounded-[1.75rem] p-[5px]">
            <div className="hev-core rounded-[calc(1.75rem-5px)] p-10 sm:p-12 text-center">
              ...
              <p className="mt-4 text-[14px] text-foreground/60 max-w-sm mx-auto leading-relaxed">
                Your bag is safe. Try once more — or head back to keep shopping.
              </p>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                >
                  <span className="text-[12.5px] font-medium tracking-tight inline-flex items-center gap-1.5">
                    <ShoppingBag className="h-3.5 w-3.5" strokeWidth={STROKE} />
                    Keep shopping
                  </span>
